...
# Configuration
API_BASE = "https://mazigho-shop.preview.emergentagent.com/api"
...
def main():
    ...
    try:
        ...
        if success_count > 0:
            ...
            print("Vous pouvez maintenant les voir sur: https://mazigho-shop.preview.emergentagent.com/recipes")
